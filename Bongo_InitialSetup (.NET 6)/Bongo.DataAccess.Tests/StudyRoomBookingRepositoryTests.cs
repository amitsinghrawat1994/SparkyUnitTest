...
namespace Bongo.DataAccess
{
    ...
    {
        public StudyRoomBooking studyRoomBooking_One;
        public StudyRoomBooking studyRoomBooking_Two;
        ...
        public void SaveBooking_Booking_One_CheckTheValuesFromDatabase()
        {
            ...
            using (var context = new ApplicationDbContext(options))
            {
                var bookingFromDb = context.StudyRoomBookings.FirstOrDefault(v => v.BookingId == 11);
        ...
        [Test]
        [Order(2)]
        public void SaveBooking_BookingOneAndTwo_CheckBothTheBooksFromDatabase()
        {
            // arrange
            var expectedResult = new List<StudyRoomBooking>
            {
                studyRoomBooking_One, studyRoomBooking_Two
            };
